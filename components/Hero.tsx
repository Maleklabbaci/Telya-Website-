...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      {
        // Load the video a bit before it enters the viewport
        rootMargin: '200px',
      }
    );
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      <video 
        ref={videoRef}
        poster="https://images.pexels.com/videos/3254009/pexels-photo-3254009.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
        autoPlay
        loop
        muted
        playsInline
      ...
      >
        <source data-src="https://videos.pexels.com/video-files/3254009/3254009-hd_1920_1080_25fps.mp4" type="video/mp4" />

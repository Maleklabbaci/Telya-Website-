...
const Contact: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Envoi des données brutes du formulaire.
        // Formspark peut ainsi les traiter comme des champs individuels.
        const submissionData = {
          ...formData,
          _subject: `Telya Contact: ${formData.subject}`, // Sujet personnalisé pour l'email Formspark
        ...
        // Ce timeout est artificiel pour s'assurer que le spinner est visible au moins 1s

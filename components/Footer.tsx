...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-brand-green-500 transition-colors">
    {children}
  </a>
);
      ...
      <div className={`container mx-auto px-6 py-12 transition-opacity duration-1000 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          <div className="flex space-x-6">
            <SocialIcon href="https://www.facebook.com/profile.php?id=61577443097904">
            ...
            <SocialIcon href="https://www.instagram.com/telyaagency/">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Telya Agency. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );

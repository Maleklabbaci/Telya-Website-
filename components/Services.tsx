...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, index, isVisible }) => {
  return (
    <div
      className={`bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 border border-gray-100 flex flex-col items-center text-center transform transition-all duration-300 ease-in-out ${
